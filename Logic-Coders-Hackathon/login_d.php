<?php
	...
	if(isset($_POST['loginbtn']))
	{
		...
		$sql = "SELECT * from doctor_details where email='$myemail' and password='$mypassword' ";
		...
		if($count==1) {
			...
			header("location:Doctor_Query.php");
		}
		else {
...
<style>
	body {
		background-image: url("abc2.webp");
...
<body>
<div class="mainbox">
	<span class="titlelogin">Login Page For Doctor</span>
	...
	<div class="bottom">
		...
		<a href="signup_d.php" class="txt2">Sign up</a>
	</div>

...
session_start();
	...
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		$sql = "SELECT * FROM doctor_details WHERE mobile_no='$mymobilenumber' OR email='$myemail' ";
		...
		if ($error == 0) {
			...
			$query = "INSERT INTO doctor_details (username,mobile_no,email,password) 
...
<div class="mainbox">
	...
	<div class="bottom">
		...
		<a href="login_d.php" class="txt2">Log In</a>
	</div>
